...
class VariantSelects extends HTMLElement {
  ...
  setUnavailable() {
    ...
    if (price) {
      ...
      price.innerHTML = '<div class="price price--large price--show-badge"><div class="price__container"><span class="price-item price-item--regular">From $' + lowestPrice + '</span></div></div></div>';
    }
