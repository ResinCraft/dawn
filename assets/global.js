  ...
  rebuildOptions() {
	...
	fieldsets.forEach((fieldset, index) => {
		...
		if(fieldsets.length > 1 && index > 0) {
            ...
            console.log(fieldsets[index - 1].querySelector('input:checked:class*="disabled"'));
            if(!fieldsets[index - 1].querySelector('input:checked') && fieldsets[index - 1].querySelector('input:checked:class*="disabled"')) {
