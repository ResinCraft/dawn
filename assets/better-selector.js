...
seletedVariant = (urlVariantId) ? window.productJSON.variants.filter((item)=>item["id"] == urlVariantId)[0] : false;
...
function validOptions(select,parentValue) {
    ...
    filteredVariants.forEach(function(variant) {
      ...
      console.log('seletedVariant[childOptionText]: '+seletedVariant[childOptionText]);
